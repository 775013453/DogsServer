package com.wondergroup.example.conpon.dao.impl;
...
@Transactional
@Repository
public class ConponDaoImpl implements ConponDao{
	...
	public List<Conpon> getAllList() {
		...
		hql.append("from conpon u where 1=1");
