package com.wondergroup.example.handle.SysGoodsTable.dao.impl;
...
/**
  * @ClassName: SysGoodsTableDaoImpl
  * @Description: Dao接口类
  * @author Ouyang
...
@Repository
public class SysGoodsTableDaoImpl implements SysGoodsTableDao{
	...
	public List<SysGoodsTable> getAllList() {
		...
		hql.append("from SysGoodsTable u where 1=1");
