package com.wondergroup.example.handle.SysOrdersTable.action;
...
/**
  * @ClassName: SysOrdersTableController
  * @Description: (描述)
  * @author Ouyang
...
@Controller
@RequestMapping(value="sysOrdersTable")
public class SysOrdersTableController {

	@Autowired
	private SysOrdersTableService service;
	...
	@ResponseBody
	public String getList(SysOrdersTable entity,Integer page,Integer rows) {		
		Map <String,Object> map =new HashMap<String,Object>();
	...
	@ResponseBody
	public Map<String, Object> add(SysOrdersTable entity) {
		service.add(entity);
		Map<String, Object> map=new HashMap<String, Object>();
	...
	@ResponseBody
	public Map<String, Object> update(SysOrdersTable entity) {
	...
	@ResponseBody
	public Map<String, Object> delete(SysOrdersTable entity) {		
