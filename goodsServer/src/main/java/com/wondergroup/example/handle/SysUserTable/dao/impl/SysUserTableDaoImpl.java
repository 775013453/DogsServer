package com.wondergroup.example.handle.SysUserTable.dao.impl;
...
@Repository
public class SysUserTableDaoImpl implements SysUserTableDao{
	...
	public List<SysUserTable> getAllList() {
		...
		hql.append("from SysUserTable u where 1=1");
