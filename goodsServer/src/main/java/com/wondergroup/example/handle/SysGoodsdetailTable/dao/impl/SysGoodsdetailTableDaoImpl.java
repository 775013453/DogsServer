package com.wondergroup.example.handle.SysGoodsdetailTable.dao.impl;
...
/**
  * @ClassName: SysGoodsdetailTableDaoImpl
  * @Description: Dao接口类
  * @author Ouyang
...
@Repository
public class SysGoodsdetailTableDaoImpl implements SysGoodsdetailTableDao{
	...
	public List<SysGoodsdetailTable> getAllList() {
		...
		hql.append("from SysGoodsdetailTable u where 1=1");
		List<SysGoodsdetailTable> list=new ArrayList<SysGoodsdetailTable>();			
