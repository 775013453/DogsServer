package com.wondergroup.example.recommendation.action;
...
public class RecommendationController {
	...
	@ResponseBody
	public String getList(Recommendation entity,Integer page,Integer rows) {		
		Map <String,Object> map =new HashMap<String,Object>();
	...
	@ResponseBody
	public Map<String, Object> add(Recommendation entity) {
		service.add(entity);
		Map<String, Object> map=new HashMap<String, Object>();
	...
	@ResponseBody
	public Map<String, Object> update(Recommendation entity) {
	...
	@ResponseBody
	public Map<String, Object> delete(Recommendation entity) {		
