package com.wondergroup.example.goodsRelatePic.dao.impl;
...
/**
  * @ClassName: goodsRelatePicDaoImpl
  * @Description: Dao接口类
  * @author Ouyang
...
@Transactional
@Repository
public class GoodsRelatePicDaoImpl implements GoodsRelatePicDao{
	...
	public List<GoodsRelatePic> getAllList() {
		...
		hql.append("from goodsRelatePic u where 1=1");
